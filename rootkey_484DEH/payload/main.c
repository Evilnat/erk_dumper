...
//#define GAMEOS_LPAR_BASE_PTR KERNEL_ADDRESS(0x3C9EB8)
//#define GAMEOS_LPAR_SIZE_PTR KERNEL_ADDRESS(0x3C9EC0)

#define GAMEOS_LPAR_BASE_PTR KERNEL_ADDRESS(0x3C9EA8)
#define GAMEOS_LPAR_SIZE_PTR KERNEL_ADDRESS(0x3C9EB0)
