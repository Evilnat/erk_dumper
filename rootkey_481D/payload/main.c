...
//00 00 50 00 00 30 00 00 00 00 00 00 00 0A 00 00

#define GAMEOS_LPAR_BASE_PTR KERNEL_ADDRESS(0x37A638) // 0x3A1238
#define GAMEOS_LPAR_SIZE_PTR KERNEL_ADDRESS(0x37A640) // 0x3A1240

//#define GAMEOS_LPAR_BASE_PTR KERNEL_ADDRESS(0x3A1238)
//#define GAMEOS_LPAR_SIZE_PTR KERNEL_ADDRESS(0x3A1240)
